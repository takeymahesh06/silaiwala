"""
Django settings for silaiwala_backend project.
...
SECRET_KEY = "django-insecure-x+cy)id2=)+96u!zy(l(zktdek%he##*zg(6y3doco42pe2jgv"
...
ROOT_URLCONF = "silaiwala_backend.urls"
...
WSGI_APPLICATION = "silaiwala_backend.wsgi.application"
